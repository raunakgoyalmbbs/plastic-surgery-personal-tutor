...
async def _ollama_model_if_cache(
    ...
    **kwargs,
    ...
    # timeout=None: no httpx read timeout — local Ollama inference can take many minutes
    # per chunk on large models (e.g. qwen2.5:14b); LLM_TIMEOUT in .env acts as the
    # outer asyncio safety net instead.
